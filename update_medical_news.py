...
def render_academic_cards(items: list, journal_type: str) -> str:
    ...
    journal_label = JOURNAL_LABELS.get(journal_type, journal_type.upper())
    out = []
    for a in items:
        out.append(
            ...
            f'    <span class="journal-badge {journal_type}">{journal_label}</span>\n'
...
def main():
    ...
    print("\n✅ 完成！網頁已更新。")
    print(f"   GitHub Pages：https://chiufw-max.github.io/aievolution/")
