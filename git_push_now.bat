...
%GIT% add index.html weekly.html education.html medical_news_data.json update_medical_news.py vercel.json robots.txt sitemap.xml git_push_now.bat .gitignore logo.jpg logo2.jpg logo3.jpg og_facebook.jpg education/painless-endoscopy.html education/masld.html education/ckm.html
